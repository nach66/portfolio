            ...
            <Roll bottom>
                ...
                <article className="right">
                    <Fade bottom>
                        ...
                        <h5>
                        תמיד אהבתי לפתור פאזלים, ולשחק במילים וצבעים.
                        באופן הכללי אני נהנית מלתכנן ולתקן, 
                        עד להרכבת התמונה המושלמת. 
                        בניית אתרים היא פאזל מורכב וצבעוני: החל מתכנון המבנה תוך הקשבה לחלום של הלקוח, 
                        דרך הרכבה מדוייקת של טכנולוגיות החדשניות והמהירות ביותר, 
                        ועד לשיפוצים האחרונים של העיצוב, שיוצר את האווירה באתר.
                        </h5>
                    </Fade>
                </article>
