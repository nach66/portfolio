...
export default class Include extends Component {
    state={
        ...
        programs: [
                    {
                        title:"פיתוח מותאם אישית בקוד",
                        list: [
                            'מערכות למידה וקורסים אונליין',
                            'פיתוח פאנלים ותהליכי עבודה מותאמים אישית',
                            'ניהול מידע, נתונים ואוטומציות',
                            'פיתוח על אתרים קיימים או חדשים ב־WordPress',
                        ],
                    },
                    {
