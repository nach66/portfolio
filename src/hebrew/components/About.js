                    ...
                    <article className="left centerr">
                        <Fade bottom>
                            <h3>למה לצאת לדרך דווקא איתי?</h3>
                                <p>
                                אני מציעה פתרון עוטף לבניית האתר: מיקוד הצרכים באפיון, עיצוב ובנייה מקצועיים, והדרכה לשימוש במערכת האתר בסיום. יש אפשרות לשלב כתיבת תוכן: כתיבה שיווקית לאתר ומאמרי seo, ואף ניהול ותחזוקה של האתר להמשך הדרך.
                                </p>
                                <br/>
                                <p>
