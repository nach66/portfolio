...
export default function Prolog() {
    return (
        <div className="prolog">
                ...
                <p>אתם צריכים אתר יפיפה ומודרני, נגיש ומאובטח, מהיר למרות שהוא מכיל ממש הכול. אתר שמעוצב באווירה שתהיו מעוניינים ליצור אצל הלקוח שמבקר בעסק שלכם, ונותן לו גישה מהירה ומהנה לשימוש בשירות אותו אתם מציעים.</p>
