...
<div>
    <h6>                            
        <br/>
        "יוני לקחה את האתר שלנו לפני שנה, שיקמה אותו, בנתה לו תוספות מורכבות והדריכה אותנו בסבלנות אין קץ.
        <br/>
        לעבוד עם יוני זה לא לעבוד עם סתם איש מקצוע: היא דואגת להבין לעומק את הצרכים של העסק ושל המערכת שהיא בונה.
        היא מסבירה הכל בנועם וממקום של הבנה אמיתית של המקצוע שלה.
        <br/>
        וזמינות? אין דברים כאלה!
        לרוץ אליה, ומי שרוצה לראות מה בנתה לנו ולקבל עוד מידע, אפשר לפנות אליי בשמחה."
</h6>

    <h6 style={{fontWeight:'bold'}}>
        ד"ר רות לובשבסקי-עמר, Wordplay
    </h6>
                                <br/>
