...
export default class PortfolioPro extends Component {
  state = {
    systems: [
      ...
      },
      {
        ...
        intro: 'ריכוז מידע על תלמידים, כיתות ומדדים פדגוגיים לאורך השנה. המערכת מאפשרת לזהות תלמידים הזקוקים לליווי מיוחד, לעקוב אחר מצב כיתות שונות בבית הספר ולקבל תמונת מצב רחבה דרך פאנל הנהלה מרכזי.',
        sections: [
          {
            image: anan1,
  ...
  render() {
    return (
      <div className="services portfolio-pro-section">
        <div className="post-cotain portfolio-pro-article">

          <h1>פיתוח מערכות מותאמות אישית בקוד</h1>

          <p>
            פאנלים ותהליכי עבודה נבחרים מתוך מערכות שפיתחתי עבור מוסדות וצוותים חינוכיים.
          </p>
          ...
          {this.state.systems.map((system, index) => (
            <div className="portfolio-article-system" key={index}>
              ...
              <ol className="portfolio-feature-list">
                {system.sections.map((section, sectionIndex) => {
                  const isWide = index === 0 && sectionIndex === 1;

                  return (
                    <li
                      className={
                        isWide
                          ? 'portfolio-feature-row portfolio-feature-wide'
                    ...
                    >
                      ...
                      <div className="portfolio-feature-image">
                        <img
                          className="portfolio-system-screenshot"
                          src={section.image}
                          alt={section.title}
                        />
                      </div>
